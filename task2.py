"""
Лабораторна робота №1. Завдання 2. Варіант 2.
Модифікація програми завдання 1: цикл до введення "ключового" значення x.

Програма працює в циклі, обчислюючи значення складної функції,
поки користувач не введе задане "ключове" значення x.
"Ключове" значення задається користувачем на початку роботи програми.
"""
